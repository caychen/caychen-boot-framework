...
import com.caychen.boot.common.constant.RegexConstant;
import com.caychen.boot.common.constant.SymbolConstant;
import com.caychen.boot.common.utils.validate.ValidateUtil;
...
public class DesensitizationUtil {
     ...
     */
    public static String covertMobile(String value) {
     ...
     */
    public static String covertIdCard(String value) {
        if (org.apache.commons.lang3.StringUtils.isEmpty(value)) {
            return value;
        }
     ...
     */
    public static String covertText(String value, int startLen, int endLen) {
